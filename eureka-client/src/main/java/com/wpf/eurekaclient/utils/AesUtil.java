/**
 * @Title: AesUtil.java
 * @Package com.wpf.eurekaclient.utils.encrypt
 * @Description: TODO(用一句话描述该文件做什么)
 * @author pengfei.wang
 * @date 2019年4月4日 上午11:23:55
 * @version V1.0
 */
...
public class AesUtil {
  ...
  public static final String ENCODERULES = "ZeRTwXI0H9iOKG9Q19VPIl08d7zEuzr";
  /*
  ...
  public static void main(String[] args) {
    String s = AesUtil.encode("aaasdfsfsdfsd",
      "{doctor_guid:b3c83ecb-fb4e-4103-8d58-6093554475d0}");
    System.out.println(s);
    System.out.println(AesUtil.decode("aaasdfsfsdfsd", s));
